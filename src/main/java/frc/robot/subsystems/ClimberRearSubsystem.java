...
public class ClimberRearSubsystem extends SubsystemBase {
  private WPI_TalonFX rearClimberMotorChannel = new WPI_TalonFX(ClimberConstants.rearClimberMotorChannel);
  ...
  public ClimberRearSubsystem() { 
    rearClimberMotorChannel.setInverted(true);
...
*/
  ...
  public double getRearClimberCalculatedPosition() {
    return (rearClimberMotorChannel.getSelectedSensorPosition() * (ClimberConstants.rearClimberEncoderDistanceConversion));
  }
