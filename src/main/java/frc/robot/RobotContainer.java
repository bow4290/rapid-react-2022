...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    if (Flags.indexer) {
      redBallColorSensorI2C  = new RevColorSensor(0.325, 1.0, 0.35, 0.50, 0.05, 0.18, 0, 2047, true);
      blueBallColorSensorI2C = new RevColorSensor(0.145, 0.3, 0.35, 0.50, 0.20, 1.00, 0, 2047, true);
      redBallColorSensorMXP  = new RevColorSensor(0.325, 1.0, 0.35, 0.50, 0.05, 0.18, 0, 2047, false);
      blueBallColorSensorMXP = new RevColorSensor(0.145, 0.3, 0.35, 0.50, 0.20, 1.00, 0, 2047, false);
